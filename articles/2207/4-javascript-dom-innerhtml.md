...
## innerHTML
innerHTMLプロパティは、特定の要素に対して、要素内のHTML文を文字列で取得することができます。
```javascript
element.innerHTML;
```
また、新しくHTML文を書き込むことや既存のものを変更することもできます。
```javascript
...
### HTMLコンテンツの書き込み
innerHTMLプロパティは、参照するだけでなく新しくHTMLコンテンツの書き込みを行うことができます。
